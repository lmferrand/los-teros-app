...
export const DEF_CAMPOS: DefCampo[] = [
  ...
  { clave: 'descripcion', label: 'Trabajo a realizar (concepto)', tipo: 'info', mapeaAVenta: false },
...
export const extractorSimulado: ExtractorDocumentos = {
  async extraer(file: File): Promise<Extraccion> {
    ...
    const crudos = [
      ...
      { clave: 'descripcion', valor: 'Limpieza integral de campanas extractoras y conductos de cocina: desengrasado, sustitución de filtros y revisión de turbinas de extracción.', confianza: 'media' },
