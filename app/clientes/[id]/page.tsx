                  ...
                  <div className="w-full px-5 py-4 flex items-center justify-between">
                    <button className="flex items-center gap-3 flex-wrap flex-1 text-left"
                      ...
                      <span className="text-xs px-2 py-0.5 rounded-full capitalize"
                        style={{ background: TIPO_OT[o.tipo]?.bg, color: TIPO_OT[o.tipo]?.color }}>
                        {o.tipo}
                      </span>
                      <span className="text-xs px-2 py-0.5 rounded-full"
                        style={{ background: ESTADO_OT[o.estado]?.bg, color: ESTADO_OT[o.estado]?.color }}>
                                ...
                                <div className="grid grid-cols-2 md:grid-cols-4 gap-2">
                                  {fotasTipo.map((f: any) => (
                                    <a key={f.id} href={f.url} target="_blank" rel="noreferrer">
                                      <img src={f.url} alt={key} className="w-full h-28 object-cover rounded-xl hover:opacity-80"
